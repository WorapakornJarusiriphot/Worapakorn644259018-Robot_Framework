...
${TIMESTAMP}      ${time}
${VALID_EMAIL}    worapakorn${TIMESTAMP}@gmail.com
${VALID_USERNAME} worapakorn${TIMESTAMP}
...
TC 2.0.005 ตรวจสอบการสมัครสมาชิกด้วย Username ซ้ำ
    ...
    Page Should Contain    Username นี้มีคนใช้แล้ว
    Capture Page Screenshot    ${SCREENSHOT_DIR}/TC-5/fail_${TIMESTAMP}.png
...
TC 2.0.006 ตรวจสอบการสมัครสมาชิกด้วย Password ที่ไม่ถูกต้อง
    ...
    Capture Page Screenshot    ${SCREENSHOT_DIR}/TC-6/fail_${TIMESTAMP}.png
...
TC 2.0.007 ตรวจสอบการสมัครสมาชิกด้วย Phone Number ที่ไม่ถูกต้อง
    ...
    Capture Page Screenshot    ${SCREENSHOT_DIR}/TC-7/fail_${TIMESTAMP}.png
...
TC 2.0.008 ตรวจสอบการสมัครสมาชิกด้วยวันเกิดที่ไม่ถูกต้อง
    ...
    Capture Page Screenshot    ${SCREENSHOT_DIR}/TC-8/fail_${TIMESTAMP}.png
