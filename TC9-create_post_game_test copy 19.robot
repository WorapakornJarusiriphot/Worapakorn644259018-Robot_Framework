...
TC 9001 ทดสอบการสร้างโพสต์นัดเล่น
    ...
    # รอให้ element อัปโหลดรูปภาพพร้อมใช้งาน
    Wait Until Element Is Visible    id=games_image    timeout=5s
    Wait Until Element Is Enabled    id=games_image    timeout=5s

    # เลื่อนมุมมองไปยัง element อัปโหลดรูปภาพ
    Scroll Element Into View    id=games_image
