...
Register With Valid Data
    ...
    Execute JavaScript    document.querySelector('input[placeholder="MM/DD/YYYY"]').value = '01/01/1990';
...
Register With Duplicate Email Or Username
    ...
    Input Text    id=password    Password-123
    Click Element    css=button[aria-label="Choose date"]
    Execute JavaScript    document.querySelector('input[placeholder="MM/DD/YYYY"]').value = '05/13/2024';
    Click Element    css=input[type='radio'][value='ชาย']
    Click Button    css=button[type="submit"]
