...
TC 9001 ทดสอบการสร้างโพสต์นัดเล่น
    ...
    Click Element    xpath=//li[text()='Magic the gathering']    # ชื่อบอร์ดเกมที่ต้องการ
    # Click Element    xpath=//li[text()='ชื่อบอร์ดเกมที่ต้องการเลือก']    # ปรับชื่อเกมตามที่ต้องการ
    # กรอกข้อมูลในฟิลด์ "รายละเอียดของโพสต์"
    
    # กรอกข้อมูลในฟิลด์ "รายละเอียดของโพสต์"
    Input Text    id=detail_post    เอา Magic the gathering ตัวเสริมมาด้วยก็ดีนะ เพราะเรามีแค่ตัวหลัก    timeout=10s
